...
resourcename="catanmanagerdb"  # lower case, only
resourcegroup="catanmanagerdb_rg"
...
# git clone https://github.com/apilogicserver/catanmanagerdb.git
# cd catanmanagerdb
...
az group create --name catanmanagerdb_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group catanmanagerdb_rg --sku S1 --is-linux
az container create --resource-group catanmanagerdb_rg --name catanmanagerdb --image apilogicserver/catanmanagerdb:latest --dns-name-label catanmanagerdb --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//catanmanagerdb.westus.azurecontainer.io:5656'
